...
h_stat_CCnumu_nuE = rt.TH2F("h_stat_CCnumu_nuE","Fractional Covariance Matrix",19,0,19,19,0,19)
h_stat_CCnue_lepP = rt.TH2F("h_stat_CCnue_lepP","Fractional Covariance Matrix",8,0,8,8,0,8)
h_stat_CCnumu_lepP = rt.TH2F("h_stat_CCnumu_lepP","Fractional Covariance Matrix",16,0,16,16,0,16)
...
h_cnp_CCnumu_nuE = rt.TH2F("h_cnp_CCnumu_nuE","Fractional Covariance Matrix",19,0,19,19,0,19)
h_cnp_CCnue_lepP = rt.TH2F("h_cnp_CCnue_lepP","Fractional Covariance Matrix",8,0,8,8,0,8)
h_cnp_CCnumu_lepP = rt.TH2F("h_cnp_CCnumu_lepP","Fractional Covariance Matrix",16,0,16,16,0,16)
...
f_sbn_CCnumu_nuE = rt.TFile("systematics/CCnumuInc_nuE_rebinned/SBNfit_covariance_plots_CCnumuInc_nuE_rebinned.root")
f_sbn_CCnumu_lepP = rt.TFile("systematics/CCnumuInc_lepP_rebinned/SBNfit_covariance_plots_CCnumuInc_lepP_rebinned.root")
...
h_det_CCnumu_nuE = rt.TH2F("h_det_CCnumu_nuE","Fractional Covariance Matrix",19,0,19,19,0,19)
h_det_CCnue_lepP = rt.TH2F("h_det_CCnue_lepP","Fractional Covariance Matrix",8,0,8,8,0,8)
h_det_CCnumu_lepP = rt.TH2F("h_det_CCnumu_lepP","Fractional Covariance Matrix",16,0,16,16,0,16)
...
for detvar in detvars:
  f = rt.TFile("systematics/detvar/calculate_detvar_systematics_%s_ccnueChi2BinningNoBkgHack_ccnumuNewOverflowBinning_output.root"%detvar, "READ")
  ...
  h_det_CCnumu_nuE.Add(CCnumu_nuE)
  h_det_CCnue_lepP.Add(CCnue_lepP)
  h_det_CCnumu_lepP.Add(CCnumu_lepP)
...
h_fullFrac_CCnumu_nuE = rt.TH2F("h_fullFrac_CCnumu_nuE","Fractional Covariance Matrix for CC #nu_{#mu} Selection Binned in E_{#nu}",19,0,19,19,0,19)
...
h_fullFrac_CCnumu_lepP = rt.TH2F("h_fullFrac_CCnumu_lepP","Fractional Covariance Matrix for CC #nu_{#mu} Selection Binned in p_{#mu}",16,0,16,16,0,16)
...
outfile = rt.TFile("calculate_chi2_final_full_coviance_plots.root", "RECREATE")
