...
parser.add_argument("-o", "--outfile", type=str, default="plot_selection_test_results_cut_efficiency_output.root", help="output root file name")
...
h_nu_effRat2 = rt.TH1F("h_nu_effRat2","Inclusive CCnue Efficiency",40,0,4)
h_nu_effRat3 = rt.TH1F("h_nu_effRat3","Inclusive CCnue Efficiency",40,0,4)
h_nu_effRat4 = rt.TH1F("h_nu_effRat4","Inclusive CCnue Efficiency",40,0,4)
h_nu_effRat5 = rt.TH1F("h_nu_effRat5","Inclusive CCnue Efficiency",40,0,4)
h_nu_effRat6 = rt.TH1F("h_nu_effRat6","Inclusive CCnue Efficiency",40,0,4)
h_nu_effRat7 = rt.TH1F("h_nu_effRat7","Inclusive CCnue Efficiency",40,0,4)
...
h_nu_effRat2 = configureHist(h_nu_effRat2, rt.kBlack, "neutrino", "effRaticiency")
h_nu_effRat3 = configureHist(h_nu_effRat3, rt.kBlack, "neutrino", "effRaticiency")
h_nu_effRat4 = configureHist(h_nu_effRat4, rt.kBlack, "neutrino", "effRaticiency")
h_nu_effRat5 = configureHist(h_nu_effRat5, rt.kBlack, "neutrino", "effRaticiency")
h_nu_effRat6 = configureHist(h_nu_effRat6, rt.kBlack, "neutrino", "effRaticiency")
h_nu_effRat7 = configureHist(h_nu_effRat7, rt.kBlack, "neutrino", "effRaticiency")
...
h_nu_effRat2.Divide(h_nu_wCuts2,h_nu_wCuts1,1,1,"B")
h_nu_effRat3.Divide(h_nu_wCuts3,h_nu_wCuts2,1,1,"B")
h_nu_effRat4.Divide(h_nu_wCuts4,h_nu_wCuts3,1,1,"B")
h_nu_effRat5.Divide(h_nu_wCuts5,h_nu_wCuts4,1,1,"B")
h_nu_effRat6.Divide(h_nu_wCuts6,h_nu_wCuts5,1,1,"B")
h_nu_effRat7.Divide(h_nu_wCuts7,h_nu_wCuts6,1,1,"B")
...
h_nu_effRat2.GetYaxis().SetRangeUser(0,1.003)
h_nu_effRat3.GetYaxis().SetRangeUser(0,1.003)
h_nu_effRat4.GetYaxis().SetRangeUser(0,1.003)
h_nu_effRat5.GetYaxis().SetRangeUser(0,1.003)
h_nu_effRat6.GetYaxis().SetRangeUser(0,1.003)
h_nu_effRat7.GetYaxis().SetRangeUser(0,1.003)
