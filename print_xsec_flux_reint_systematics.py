...
if "CCnueInc" in args.tag and ("nuE" in args.tag or "lepP" in args.tag):
...
if "CCnumuInc" in args.tag and ("nuE" in args.tag or "lepP" in args.tag):
...
if "nuE" in args.tag and "cutSet" not in args.tag:
