...
images = ["ubspurn_shower", "ubspurn_track"]
pixel_diffs = []
...
for image_type in images:
  ...
  if image_type == "ubspurn_shower":
    adc_v1 = [iolcv1.get_data(larcv.kProductImage2D, "ubspurn_plane0").Image2DArray()[0]]
    adc_v1.append(iolcv1.get_data(larcv.kProductImage2D, "ubspurn_plane1").Image2DArray()[0])
    adc_v1.append(iolcv1.get_data(larcv.kProductImage2D, "ubspurn_plane2").Image2DArray()[0])
    adc_v2 = [iolcv2.get_data(larcv.kProductImage2D, "ubspurn_plane0").Image2DArray()[0]]
    adc_v2.append(iolcv2.get_data(larcv.kProductImage2D, "ubspurn_plane1").Image2DArray()[0])
    adc_v2.append(iolcv2.get_data(larcv.kProductImage2D, "ubspurn_plane2").Image2DArray()[0])
  elif image_type == "ubspurn_track":
    adc_v1 = [iolcv1.get_data(larcv.kProductImage2D, "ubspurn_plane0").Image2DArray()[1]]
    adc_v1.append(iolcv1.get_data(larcv.kProductImage2D, "ubspurn_plane1").Image2DArray()[1])
    adc_v1.append(iolcv1.get_data(larcv.kProductImage2D, "ubspurn_plane2").Image2DArray()[1])
    adc_v2 = [iolcv2.get_data(larcv.kProductImage2D, "ubspurn_plane0").Image2DArray()[1]]
    adc_v2.append(iolcv2.get_data(larcv.kProductImage2D, "ubspurn_plane1").Image2DArray()[1])
    adc_v2.append(iolcv2.get_data(larcv.kProductImage2D, "ubspurn_plane2").Image2DArray()[1])
  ...
  for p in range(3):
    ...
    for r in range(adc_v1[p].meta().rows()):
      for c in range(adc_v1[p].meta().cols()):
        if abs(adc_v1[p].pixel(r,c) - adc_v2[p].pixel(r,c)) > 1e-6:
          ...
          pixel_diffs.append(abs(adc_v1[p].pixel(r,c) - adc_v2[p].pixel(r,c)))

print(pixel_diffs)

#if len(pixel_diffs) > 0:
#  print("hello?")
#  plt.hist(pixel_diffs, bins=20)
#  plt.title("difference in ssnet pixel values for 1 test event")
#  plt.show()
